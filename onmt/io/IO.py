...
def get_fields(data_type, n_src_features, n_tgt_features, n_src_hist_nfeats1):
    """
    Args:
    ...
    """
    if data_type == 'text':
        return TextDataset.get_fields(n_src_features, n_tgt_features, n_src_hist_nfeats1)
    elif data_type == 'img':
...
def load_fields_from_vocab(vocab, data_type="text"):
    ...
    """
    vocab = dict(vocab)
    n_src_features = len(collect_features(vocab, 'src2'))
    n_src_hist_features = len(collect_features(vocab, 'src1_hist'))
    n_tgt_features = len(collect_features(vocab, 'tgt2'))
    fields = get_fields(data_type, n_src_features, n_tgt_features, n_src_hist_features)
...
def build_dataset(fields, data_type, src_path, src_hist_path, src_path2, tgt_path2, src_dir=None,
    ...
    if data_type == 'text':
        dataset = TextDataset(fields, src_examples_iter, src_hist_examples_iter, src_examples_iter2, tgt_examples_iter2,
                              num_src_feats, num_src_hist_feats, 
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    if data_type == 'text':
        for src in ("src1", "src2", "src1_hist"):
