...
class TextDataset(ONMTDatasetBase):
    """ Dataset for data_type=='text'
        ...
        Args:
            ...
            use_filter_pred (bool): use a custom filter predicate to filter
                out examples?
    """
    def __init__(self, fields, src_examples_iter, src_hist_examples_iter, src2_examples_iter, tgt2_examples_iter,
                 num_src_feats=0, num_src_hist_feats=0, num_src_feats2=0, num_tgt_feats2=0,
        ...
        self.n_tgt_feats = num_tgt_feats2
        ...
        if tgt2_examples_iter is not None:
            if src_hist_examples_iter is not None:
                examples_iter = (self._join_dicts(src, src2, tgt2, src1_hist) for src, src2, tgt2, src1_hist in
                             zip(src_examples_iter, src2_examples_iter, tgt2_examples_iter, src_hist_examples_iter))
            else:
                examples_iter = (self._join_dicts(src, src2, tgt2) for src, src2, tgt2 in
                             zip(src_examples_iter, src2_examples_iter, tgt2_examples_iter))
    ...
    def make_text_examples_nfeats_tpl(path, truncate, side):
        ...
        """
        assert side in ['src1', 'src2', 'tgt2', 'src1_hist']
    ...
    @staticmethod
    def get_fields(n_src_features, n_tgt_features, n_src_hist_nfeats1):
        """
        Args:
